# spacetraders_api_client.ContractsApi
...
with spacetraders_api_client.ApiClient(configuration) as api_client:
    ...
    api_instance = spacetraders_api_client.ContractsApi(api_client)
...
with spacetraders_api_client.ApiClient(configuration) as api_client:
    ...
    deliver_contract_request = spacetraders_api_client.DeliverContractRequest() # DeliverContractRequest |  (optional)
