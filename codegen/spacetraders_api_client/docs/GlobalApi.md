# spacetraders_api_client.GlobalApi
...
with spacetraders_api_client.ApiClient(configuration) as api_client:
    ...
    api_instance = spacetraders_api_client.GlobalApi(api_client)
...
with spacetraders_api_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = spacetraders_api_client.GlobalApi(api_client)
    register_request = spacetraders_api_client.RegisterRequest() # RegisterRequest |  (optional)
