# spacetraders_api_client.SystemsApi
...
with spacetraders_api_client.ApiClient(configuration) as api_client:
    ...
    api_instance = spacetraders_api_client.SystemsApi(api_client)
...
with spacetraders_api_client.ApiClient(configuration) as api_client:
    ...
    type = spacetraders_api_client.WaypointType() # WaypointType | Filter waypoints by type. (optional)
    traits = spacetraders_api_client.GetSystemWaypointsTraitsParameter() # GetSystemWaypointsTraitsParameter | Filter waypoints by one or more traits. (optional)
...
with spacetraders_api_client.ApiClient(configuration) as api_client:
    ...
    system_symbol = 'system_symbol_example' # str | The system symbol
    waypoint_symbol = 'waypoint_symbol_example' # str | The waypoint symbol
    supply_construction_request = spacetraders_api_client.SupplyConstructionRequest() # SupplyConstructionRequest |  (optional)
