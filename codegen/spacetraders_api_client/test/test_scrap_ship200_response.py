    ...
    def make_instance(self, include_optional) -> ScrapShip200Response:
        ...
        if include_optional:
            return ScrapShip200Response(
                data = spacetraders_api_client.models.scrap_ship_200_response_data.scrap_ship_200_response_data(
                    agent = spacetraders_api_client.models.agent.Agent(
                        ...
                        starting_faction = '0', 
                        ship_count = 56, ), 
                    transaction = spacetraders_api_client.models.scrap_transaction.ScrapTransaction(
                        waypoint_symbol = '0', 
                        ship_symbol = '', 
                        total_price = 0, 
