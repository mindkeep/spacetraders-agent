...
class Faction(BaseModel):
    ...
    headquarters: Optional[Annotated[str, Field(min_length=1, strict=True)]] = Field(default=None, description="The waypoint in which the faction's HQ is located in.")
