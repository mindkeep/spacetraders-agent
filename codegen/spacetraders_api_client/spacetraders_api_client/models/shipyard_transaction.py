...
class ShipyardTransaction(BaseModel):
    ...
    ship_symbol: StrictStr = Field(description="The symbol of the ship type (e.g. SHIP_MINING_DRONE) that was the subject of the transaction. Contrary to what the name implies, this is NOT the symbol of the ship that was purchased.", alias="shipSymbol")
    ship_type: StrictStr = Field(description="The symbol of the ship type (e.g. SHIP_MINING_DRONE) that was the subject of the transaction.", alias="shipType")
