...
class ExtractResources201ResponseData(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["cooldown", "extraction", "cargo", "modifiers", "events"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "events": [ShipConditionEvent.from_dict(_item) for _item in obj["events"]] if obj.get("events") is not None else None
        })
        return _obj
