...
class InstallShipModule201ResponseDataTransaction(BaseModel):
    """
    InstallShipModule201ResponseDataTransaction
    """ # noqa: E501
    waypoint_symbol: StrictStr = Field(alias="waypointSymbol")
    ship_symbol: StrictStr = Field(alias="shipSymbol")
    trade_symbol: StrictStr = Field(alias="tradeSymbol")
